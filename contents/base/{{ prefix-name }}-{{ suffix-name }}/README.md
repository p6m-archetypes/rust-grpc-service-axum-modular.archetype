...
* [{{ prefix-name }}-{{ suffix-name }}: Persistence](crates/{{ prefix_name }}_{{ suffix_name }}_persistence/README.md) - Persistence Logic
* [{{ prefix-name }}-{{ suffix-name }}: Server](crates/{{ prefix_name }}_{{ suffix_name }}_server/README.md) - Exposes the Core as a network server
